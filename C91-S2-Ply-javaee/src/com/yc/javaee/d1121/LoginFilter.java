...
public class LoginFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if(! (path.endsWith("login.html") || path.endsWith("register.html") || path.endsWith("count.html"))) {
			if(session.getAttribute("loginedAccount") == null) {
				...
				request.getRequestDispatcher("/1113/简单的企业MIS/login.html").forward(httpRequest, httpResponse);
				return;
			}
		}
